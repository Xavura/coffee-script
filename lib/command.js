(function() {
  var BANNER, CoffeeScript, EventEmitter, SWITCHES, compileJoin, compileOptions, compileScript, compileScripts, compileStdio, contents, exec, forkNode, fs, helpers, lint, loadRequires, optionParser, optparse, opts, parseOptions, path, printLine, printTokens, printWarn, sources, spawn, usage, version, watch, watching, writeJs, _ref;
  fs = require('fs');
  path = require('path');
        ...
        return path.exists(source, function(exists) {
          ...
          return fs.stat(source, function(err, stats) {
            ...
            if (stats.isDirectory()) {
              ...
              seen = opts.watch ? watching.indexOf(source) !== -1 : false;
